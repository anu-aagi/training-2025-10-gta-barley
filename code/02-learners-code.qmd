...
chi_pdf_by_k_test_statistic_region(
  ...
  alpha = 0.05,
  y_max = 0.15,
  p_value = pchisq(12.5, df = 8, lower.tail = FALSE),
  stitle = "Red area = observed p-value, purple = significance region",
  show_title = TRUE
) +
  coord_cartesian(c(0,30))

ggsave(here("outputs/figures/gta_pdf_k8_critical_region.pdf"), width = 6, height = 5)
```
